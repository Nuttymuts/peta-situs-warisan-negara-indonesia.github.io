...
const PH_QID                  = 'Q252'; // Negara Indonesia
const REGION_QID              = 'Q3700011'; // Kecamatan di Indonesia (alt dari Region of the Philippines)
const PROVINCE_QID            = 'Q5098'; // Provinsi di Indonesia
const HUC_QID                 = 'Q3199141'; // Kota di Indonesia (alt dari Highly Urbanized Philippines)
const CITY_QID                = 'Q26211545'; // Desa di Indonesia (alt dari City of the Philippines)
